...
class MyHyenaDNA(PreTrainedModel):
    def __init__(self, pretrained_model_name, num_of_layers=2, hidden_size=128, dropout=0.3):
      super(PreTrainedModel, self).__init__()
      self.hynedaDNA = HyenaDNAPreTrainedModel.from_pretrained('./checkpoints', pretrained_model_name, use_head=False)
